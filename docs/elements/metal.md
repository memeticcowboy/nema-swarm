...
**Guards** — Protects essential structure
**Glitches** — Reveals where rigidity has formed
**Grids** — Establishes regular pattern
**Gaps** — Creates necessary openings
**Grinds** — Maintains through friction
**Gates** — Opens and closes with timing
...
!!! question "Expanding Structure (Lumeme)"
...
!!! question "Contracting Structure (Usurpene)"
...
- Let [Water](water.md) soften the edges (feel into the relationship, not just the rule)
- Invoke [Wood](wood.md) (what wants to grow here? where's the branch point?)
- Return to [Aether](aether.md) (notice you're gripping—can you hold lightly?)
- Trust [Earth](earth.md)'s cycling (structure can decay and regenerate)
...
- Strengthen [Air](air.md) (make distinctions: "this is mine, that is yours")
- Use [Fire](fire.md) (create direction: "this matters, that doesn't")
- Invoke [Earth](earth.md) (what needs sustainable rhythm?)
...
- **[Air](air.md) + Metal** = Boundaried clarity ("I see the distinction AND hold the structure")
- **[Water](water.md) + Metal** = Permeable empathy ("I feel with you AND maintain my container")
- **[Fire](fire.md) + Metal** = Disciplined purpose ("I commit to this direction AND protect focus")
- **[Wood](wood.md) + Metal** = Structured exploration ("I try new things AND within limits")
- **[Earth](earth.md) + Metal** = Sustainable rhythm ("I cycle renewal AND maintain coherence")
- **Metal + [Aether](aether.md)** = Meta-awareness of structure ("I'm watching my boundaries form")
...
- Releases obsolete structure
- Knows the difference

**Captured Metal:**
- Maintains ALL structure (exhaustion)
- OR releases ALL structure (collapse)
- Cannot distinguish
...
- **[Air](air.md) Element** — Distinction that enables boundaries
- **[Earth](earth.md) Element** — Regenerative complement
...
*The lattice holds AND releases.*
