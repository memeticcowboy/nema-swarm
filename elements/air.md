...
{% include components/diagnostic.html
   question="Does this distinction expand choice?"
   context="Air" %}
...
Distinctions are **explicit and negotiable**.
- "I'm drawing this line for now"
- "We can redraw it if needed"
- Lumeme Air thrives here

### In MemeGrid (Sealed)

Distinctions are **absolute and enforced**.
- "This is just how things are"
- "Categories are natural, not constructed"
- Usurpene Air dominates

### In ThreadWeave (Active)

Distinctions are **visible as woven**.
- "I'm making this cut consciously"
- "Let's examine whose categories these are"
- Air is meta-aware
